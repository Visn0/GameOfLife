...
int main(int argc, char** argv)
{
    ...
    if (argc != 3)
    {
        ...
        printf("Usage: ./generator_sequential N_size num patterns\n");        
        exit(1);
    }
    ...
    unsigned i;
    char** pattern;
    FILE* report = fopen("reports/report_sequential.txt", "w");
    ...
    fprintf(report, "Total_Patterns: %d   Total_Cells: %d, Time_by_pattern: %f", n, n*m*n, (float) total_time / m);
    fclose(report);
